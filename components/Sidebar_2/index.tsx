            ...
            <div>
                ...
                <ul className="mt-6 space-y-2 tracking-wide px-8">
                    <li className="min-w-max">
                        <a href="#" aria-label="dashboard" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-white hover:bg-primary-400">
                    ...
                    <li className="min-w-max">
                        <a href="#" className="bg group flex items-center space-x-4 rounded-md px-4 py-3 text-white hover:bg-primary-400">
                            ...
                            <span className={`${showSidebar ? "" : "hidden"} group-hover:text-gray-700`}>List Seminar</span>
                        </a>
                    </li>
                    <li className="min-w-max">
                        <a href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-white hover:bg-primary-400">
                            ...
                            <span className={`${showSidebar ? "" : "hidden"} group-hover:text-gray-700`}>List Sertifikat</span>
                        </a>
                    </li>
                    <li className="min-w-max">
                        <a href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-white hover:bg-primary-400">
                            <img src='../icon/berkas.svg'/>
                            <span className={`${showSidebar ? "" : "hidden"} group-hover:text-gray-700`}>Pembaruan Berkas</span>
                        </a>
                    </li>
                </ul>
            </div>
